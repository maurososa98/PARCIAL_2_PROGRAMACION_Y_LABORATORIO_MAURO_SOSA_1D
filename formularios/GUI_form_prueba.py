...
class FormPrueba(Form):
    def __init__(self, screen, x,y,w,h,color_background, color_border = "Black", border_size = -1, active = True):
        ...
        self.btn_play = Button(self._slave, x, y, 100, 100, 100, 50, "red", "blue", self.btn_play_click, "hola", "Pause", "Verdana", 15, "white")
        
        self.slider_volumen = Slider(self._slave, x, y, 100, 200, 500, 15, self.volumen, "blue", "white")
        
        porcentaje_volumen = f"{self.volumen * 100}%"
        self.label_volumen = Label(self._slave, 650, 190, 100, 50, porcentaje_volumen, "Comic Sans MS", 15, "white", "Recursos\Table.png")
        
        self.btn_tabla = Button_Image(self._slave, x, y, 225, 100, 50, 50, "Recursos\Menu_BTN.png", self.btn_tabla_click, "")
    ...
    def btn_tabla_click(self, param):
       ...
       nuevo_form = FormMenuScore(screen = self._master, x = 250, y = 25, w = 500, h = 550, color_border = "red", color_background = "green", active = True, path_image = "Recursos\Window.png", scoreboard = diccionario, margen_x = 10, margen_y = 100, espacio = 10)
